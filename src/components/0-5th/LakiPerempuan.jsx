      ...
      <div className="w-full flex justify-center">
        <div className="w-1/2 h-[50vh] bg-[#C3D9F8]">
          <ul className="px-8 py-7">
            <li className="w-[100%] text-lg font-sansita font-semibold tracking-wide text-[#421113]">
        ...
        <div className="w-1/2 h-[50vh] bg-[#FBCBD5]">
          <ul className="px-8">
            <li className="w-[100%] text-lg font-sansita font-semibold tracking-wide text-[#421113] py-7">
